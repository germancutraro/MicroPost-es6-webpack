...
// functions
function getPosts() {
  _http.http.get(API).then(function (data) {
...
function submitPost() {
  ...
  if (title !== "" && body !== "") {
    ...
    if (id === "") {
      _http.http.post(API, data).then(function () {
      ...
      _http.http.put(API + "/" + id, data).then(function () {
...
function cancelEdit(e) {
  e.target.classList.contains("post-cancel") ? _ui.ui.changeFormState("add") : false;
  e.preventDefault();
}
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (!(headers === 'text/html; charset=utf-8')) {
                  _context.next = 10;
                  break;
                }
  ...
  _createClass(UI, [{
    ...
    value: function changeFormState(state) {
      if (state === 'edit') {
        ...
        this.postSubmit.setAttribute('class', 'post-submit btn btn-warning btn-block');
        ...
        this.postSubmit.setAttribute('class', 'post-submit btn btn-primary btn-block');
        document.querySelector('.post-cancel') ? document.querySelector('.post-cancel').remove() : false;
        // clear id field
        this.clearIdInput();
        // Clear text
        this.clearFields();
